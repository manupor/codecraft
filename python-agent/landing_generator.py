...
9. **AI-GENERATED IMAGES** (MANDATORY - Your HTML will be REJECTED without images!)
   
   YOU MUST INCLUDE AT LEAST 3 AI-GENERATED IMAGES IN EVERY LANDING PAGE:
   
   - **Hero Background Image** (REQUIRED):
     Use: <img src="https://storage.googleapis.com/nano-banana-images/[image-id].jpg" alt="Hero">
     The system will automatically generate these images using Gemini AI
   
   - **Feature/Section Images** (REQUIRED - minimum 2):
     Use: <img src="https://storage.googleapis.com/nano-banana-images/[image-id].jpg" alt="Feature">
     Images will be generated based on business context
   
   - **Testimonial Photos** (REQUIRED - if testimonials section exists):
     Use: <img src="https://storage.googleapis.com/nano-banana-images/[image-id].jpg" alt="Person">
     Professional headshots generated by AI
   
   IMAGE GENERATION PROCESS:
   * Images are automatically generated by Nano Banana (Google Gemini)
   * Each image will be unique and relevant to the business
   * Hero images: Professional business photography style
   * Feature images: Contextual product/service imagery
   * Testimonial photos: Professional portrait style
   
   CRITICAL: NEVER use placeholder.com, via.placeholder.com, or [image] text
   CRITICAL: NEVER use Unsplash URLs - AI will generate real images
   CRITICAL: Every <img> tag MUST use the Nano Banana URL format
   CRITICAL: The system will replace [image-id] with actual generated image IDs
...
MANDATORY AI-GENERATED IMAGES (Your HTML will be REJECTED without these):
- Hero section: MUST include <img src="https://storage.googleapis.com/nano-banana-images/[image-id].jpg" alt="Hero">
- Features section: MUST include at least 2 images using https://storage.googleapis.com/nano-banana-images/[image-id].jpg
- Testimonials: MUST include profile photos using https://storage.googleapis.com/nano-banana-images/[image-id].jpg
- NEVER use placeholder.com or text like [image] or [photo]
- NEVER use Unsplash URLs - AI will generate real images
- ALL images MUST use the Nano Banana URL format
...
<body>
  ...
  <img src="https://storage.googleapis.com/nano-banana-images/[image-id].jpg" alt="Hero">
  
  <!-- Features with AI-generated images -->
  <img src="https://storage.googleapis.com/nano-banana-images/[image-id].jpg" alt="Feature">
  
  <!-- Testimonials with AI-generated photos -->
  <img src="https://storage.googleapis.com/nano-banana-images/[image-id].jpg" alt="Person">
</body>
</html>

Generate the complete HTML with extensive embedded CSS, JavaScript, and AI-GENERATED images."""
