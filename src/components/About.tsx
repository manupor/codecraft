...
const projects = [
  { icon: Brain, label: "AI-powered mobile applications" },
  { icon: Server, label: "Enterprise web platforms and portals" },
  { icon: TrendingUp, label: "E-commerce and marketplace apps" },
  { icon: LayoutTemplate, label: "Custom business websites and dashboards" },
  { icon: Cloud, label: "Cloud-native app deployment (AWS / Azure / GCP)" },
  { icon: Plug, label: "Third-party API integrations and automation" },
];
          ...
          <div>
            ...
            <FadeInWhenVisible delay={0.1}>
              <p className="mt-4 text-base sm:text-lg text-zinc-200 leading-relaxed">
                CodeCraftt is a software development and AI solutions studio based in Costa Rica
                working with companies across North America and Latin America.
              </p>
            </FadeInWhenVisible>
            ...
            <FadeInWhenVisible delay={0.4}>
              <div className="mt-8 p-4 sm:p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
                <p className="text-base text-zinc-100 italic leading-relaxed">
                  &ldquo;Our mission is simple:
                  <br />
                  Turn powerful ideas into intelligent software.&rdquo;
                </p>
              </div>
            </FadeInWhenVisible>
          </div>
