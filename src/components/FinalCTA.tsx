  ...
  return (
    <section className="relative py-32 overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-orange-600/[0.04] to-transparent" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-orange-600/[0.06] blur-[100px]" />
      </div>
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#5c5f66] mb-7">
            {t.finalCta.eyebrow}
          </p>
          ...
          <p className="mt-7 text-lg text-[#b8b5ae] max-w-sm mx-auto leading-relaxed">
          ...
          <p className="mt-6 text-xs text-[#5c5f66]">
            {t.finalCta.trust}
          </p>
        </motion.div>
      </div>
