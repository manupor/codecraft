            ...
            <div className="px-6 py-6 flex flex-col gap-4">
              ...
              <div className="mt-4 pt-4 border-t border-white/10">
                <a
                  href="#contact"
                  onClick={() => setMobileOpen(false)}
                  className="text-sm font-bold px-5 py-2.5 rounded-full bg-gradient-to-r from-[#10B981] to-[#059669] text-black text-center hover:shadow-lg transition-colors block"
                >
                  Get a Quote
                </a>
              </div>
