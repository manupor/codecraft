          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6 col-sm-12 block-column">
              <div className="team-block-three">
                <figure className="image"><Link to="/"><img src="/photo%202.jpeg" alt="Manu Portuguez" style={{objectFit: "contain", objectPosition: "center top", background: "#0d0d0d"}} /></Link></figure>
