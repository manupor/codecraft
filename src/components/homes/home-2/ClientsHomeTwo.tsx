      ...
      <section className={`clients-section text-center ${style_2 ? 'about-clients' : ''}`}>
        <div className="container">
          ...
          <p style={{maxWidth: '600px', margin: '0 auto 40px', color: '#666'}}>
            Desde startups tecnológicas hasta empresas consolidadas, he tenido el privilegio de colaborar con organizaciones que buscan excelencia digital.
          </p>
          <ul className="clients-logo-list">
            ...
            <li><a href="#"><img src="assets/images/clients/OLAVIVO-HEADER-LOGO.png" alt="Olavivo" /></a></li>
          </ul>
        </div>
      </section>
    </>
