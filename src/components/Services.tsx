    ...
    <section id="services" aria-label="Software Development Services" className="relative py-28 bg-[#04060E]/50">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {services.map((s, i) => (
            <motion.div
              ...
              className="group flex gap-6 p-8 rounded-2xl border border-white/[0.06] bg-white/[0.02] hover:border-indigo-500/25 hover:bg-white/[0.04] transition-all duration-300"
            >
        ...
        >
          ...
          <span className="text-xs text-zinc-600">Also: Mobile apps, custom APIs, UX/UI design</span>
        </motion.div>
      </div>
    </section>
  );
