...
const services = [
  ...
  },
  {
    ...
    description:
      "High-performance websites designed to convert visitors into customers. Fast, responsive, and optimized for growth.",
  },
  {
    icon: BrainCircuit,
    title: "AI Solutions",
    description:
      "We integrate artificial intelligence into real business workflows. Transform your business with intelligent systems.",
  },
  {
    icon: CloudCog,
    title: "SaaS Platforms",
    description:
      "Complete SaaS product development from concept to launch with cloud infrastructure and scalability.",
  },
  {
    icon: RefreshCcw,
    title: "Digital Products",
    description:
      "End-to-end product development for startups and companies ready to innovate.",
  },
];
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <p className="mt-3 text-base sm:text-lg text-zinc-200 max-w-xl mx-auto">
            We help businesses move from concept → product → scale.
          </p>
        </motion.div>
